...
export const SOUND_LIBRARY = {
  nature: [
    { id: 'birds_morning', name: 'Morning Birds', file: 'birds_morning.mp3', category: 'nature' },
    { id: 'rain_light', name: 'Light Rain', file: 'rain_light.mp3', category: 'nature' },
    { id: 'ocean_gentle', name: 'Gentle Ocean', file: 'ocean_gentle.mp3', category: 'nature' },
    { id: 'forest_stream', name: 'Forest Stream', file: 'forest_stream.mp3', category: 'nature' },
    { id: 'wind_chimes', name: 'Wind Chimes', file: 'wind_chimes.mp3', category: 'nature' },
  ],
  ambient: [
    { id: 'piano_soft', name: 'Soft Piano', file: 'piano_soft.mp3', category: 'ambient' },
    { id: 'lofi_morning', name: 'Lo-fi Morning', file: 'lofi_morning.mp3', category: 'ambient' },
    { id: 'guitar_acoustic', name: 'Acoustic Guitar', file: 'guitar_acoustic.mp3', category: 'ambient' },
    { id: 'harp_gentle', name: 'Gentle Harp', file: 'harp_gentle.mp3', category: 'ambient' },
  ],
  familiar: [
    // These would be populated from user's music library or curated melodic alarms
    { id: 'melodic_rise', name: 'Melodic Rise', file: 'melodic_rise.mp3', category: 'familiar' },
    { id: 'morning_theme', name: 'Morning Theme', file: 'morning_theme.mp3', category: 'familiar' },
  ],
  alert: [
    { id: 'chime_bright', name: 'Bright Chime', file: 'chime_bright.mp3', category: 'alert' },
    { id: 'bell_clear', name: 'Clear Bell', file: 'bell_clear.mp3', category: 'alert' },
  ],
};
...
export const ANALYTICS_CONFIG = {
  ...
  QUALITY_WEIGHTS: {
    duration: 0.30,       // Did they sleep enough?
    consistency: 0.20,    // Same bedtime/waketime?
    efficiency: 0.20,     // Time in bed vs actual sleep
