...
export default function AnalyticsScreen() {
  ...
  const renderBarChart = () => {
    ...
    const maxDuration = Math.max(
      ...stats.weeklyTrend.map(d => d.duration || 0),
      9,
    );
      ...
      <View style={styles.chartContainer}>
        ...
        <View style={styles.barChart}>
          {stats.weeklyTrend.map((day, idx) => {
            const barHeight =
              day.duration > 0 ? (day.duration / maxDuration) * 120 : 0;
    ...
    return (
      <View style={styles.chartContainer}>
        ...
        <View style={styles.freshnessDots}>
          {stats.weeklyTrend.map((day, idx) => {
            const config =
              ANALYTICS_CONFIG.FRESHNESS_SCALE[day.freshness] ||
            ...
            <View style={styles.insightsCard}>
              ...
              {stats.averageDuration < 7 && (
                <View style={styles.insightRow}>
                  ...
                  <Text style={styles.insightText}>
                    You're averaging {stats.averageDuration}h — try to aim for
                    7-8h for optimal recovery.
                  </Text>
                </View>
              )}
              ...
              {stats.consistencyScore < 60 && (
                <View style={styles.insightRow}>
                  ...
                  />
                  <Text style={styles.insightText}>
                    Your bedtime varies a lot. A consistent sleep schedule helps
                    your body clock sync.
                  </Text>
                </View>
              )}
              ...
              {stats.averageFreshness >= 4 && (
                <View style={styles.insightRow}>
                  ...
                  />
                  <Text style={styles.insightText}>
                    Great wake freshness! The smart alarm seems to be finding
                    good wake windows for you.
                  </Text>
                </View>
              )}
              ...
              {stats.streak >= 7 && (
                <View style={styles.insightRow}>
                  ...
                  />
                  <Text style={styles.insightText}>
                    Amazing {stats.streak}-night streak! Consistent tracking
                    gives you the best insights.
                  </Text>
                </View>
              )}
            </View>
